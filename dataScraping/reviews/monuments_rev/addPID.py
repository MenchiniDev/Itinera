#modifica successiva di correzione per aggiunta di place_id alla recensione
import json

# Carica i dati dei file JSON
with open('monuments.json', 'r') as places_file:
    places_data = json.load(places_file)

with open('reviews_monuments.json', 'r') as reviews_file:
...
with open('reviews_monuments.json', 'w') as updated_reviews_file:
