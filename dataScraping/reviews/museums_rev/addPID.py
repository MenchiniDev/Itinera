...
with open('museums.json', 'r',encoding='utf-8') as places_file:
    places_data = json.load(places_file)

with open('museums_reviews.json', 'r',encoding='utf-8') as reviews_file:
...
with open('museums_reviews.json', 'w',encoding='utf-8') as updated_reviews_file:
